...
OPENAI_PROMPT_FILE_PATH = os.getenv("OPENAI_PROMPT_FILE_PATH", "openai_prompt.txt")
PERPLEXITY_PROMPT_FILE_PATH = os.getenv("PERPLEXITY_PROMPT_FILE_PATH", "perplexity_prompt.txt")
